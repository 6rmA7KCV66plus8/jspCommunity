...
public class MemberService {
	...
	public Map<String, Object> sendTempLoginPwToEmail(Member actor) { // actor : 수행자/ 서비스 레이어에서 member 대신 많이 씀
		// 메일 제목, 내용 만들기
		...
		if(sendRs == 1) {
			...
			rs.put("msg", String.format("임시 패스워드가 %s (으)로 발송되었습니다.", actor.getEmail()));
