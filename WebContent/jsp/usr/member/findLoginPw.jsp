...
<script src="https://cdnjs.cloudflare.com/ajax/libs/js-sha256/0.9.0/sha256.min.js"></script>
	...
	<div>
	<script>
	let DoFindLoginPwForm__submited = false; // 중복  작성 방지
	function DoFindLoginPwForm__submit(form){
		if(DoFindLoginPwForm__submited){ // true
			alert('처리중 입니다');	
			return;
		}
		...
		<form action="doFindLoginPw" method="post" onsubmit="DoFindLoginPwForm__submit(this); return false;">
			...
			<div>
				<div>아이디</div>
				<div><input type="text" name="loginId" maxlength="50" placeholder="아이디를 입력해주세요."/></div>
			</div>
			<hr />
			<div>
				<div>이메일</div>
